...
import { AuthContext } from "../../context/AuthContext"; // optional, if you have it
...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // persist login (via context if available, else fallback to localStorage)
      if (login) {
        login(userData);
      } else {
      ...
      toast.success("Registration successful — redirecting...", { autoClose: 1200 });
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <form onSubmit={handleRegister} className="bg-white shadow-md rounded px-8 pt-6 pb-8 w-96">
        ...
        <p className="text-blue-500 mt-3 text-center cursor-pointer" onClick={() => navigate("/login")}>
